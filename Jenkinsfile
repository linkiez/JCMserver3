        ...
        stage('Deploy') {
            steps {
                    ...
                    dir('JCMserver3') {
                        ...
                        sh "docker run -d --name JCMBackend --volume ${env.urlSSL}:/ssl --env-file ${env.envFile} --network NW_JCMMETAIS --ip 172.19.0.3 -p 57339:3001 --restart always linkiez/jcmbackend:" + LATEST_TAG
                    }
                    }
            }
        }
