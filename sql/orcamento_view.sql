...
SELECT o."createdAt", o."updatedAt", o."deletedAt", o.desconto, o.frete, o.imposto, o.prazo_emdias, o."status", o.total, p.nome AS cliente, p_e.nome AS "empresa", v_p.nome AS "vendedor" 
FROM orcamento o
